...
import logo from logo_icon; // Tell Webpack this JS file uses this image

console.log(logo); logo_icon
...
render() {
  ...
  return <img src={process.env.PUBLIC_URL + logo_icon} />;
}
```
...
import App from LoginOrRegister;
